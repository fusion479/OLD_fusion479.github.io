...
<div class="sectioncontent">
    <p class="freightfrenzypmargins" align="left" style="padding-left: 10%; margin-bottom:2%">Drivetrain</p>
    <div style="display: flex"> 
        ...
        <img src="DT.png" class="center" style="width:50vh; margin-top:-7%; margin-right:10%">
    </div>
    <p align="center" style="margin-top:0%; padding-right:7.5%">Intake</p>
    <div style="display: flex"> 
        <img src="Succ.png" class="center" style="width:60vh; margin-top:-10%; margin-left:10%">
    ...
    <p align="left" style="margin-top:0%; padding-left: 10%">Lift</p>
    <div style="display: flex"> 
    ...
    <p align="center" style="margin-top:0%; padding-right:26%">Deposit</p>
    <div style="display: flex"> 
    ...
    <p align="left" style="margin-top:0%; padding-left: 10%">Carousel Spinner</p>
    <div style="display: flex"> 
        ...
        <img src="Spinnysadsadasdsa.png" class="center" style="width:15vh; margin-top:-15%; margin-right:10%">
    </div>
</div>
<div class="sectioncontent5">
...
<div class="sectioncontent">
    <p align="center" style="padding-right:16%">Sensors</p>
    <div style="display: flex"> 
    ...
    <div style="display: flex">
        <small style="margin-left:10%; margin-right:10%; margin-top:-5%">All in all, these sensors work together to create a cohesive view of our robot, and help guide the mechanisms utilizing real-time feedback from the robot’s current status.
        </small>
    </div>
    <p align="center" style="margin-top:0%; padding-right:3%">Autonomous Path Planning & Tuning Tools</p>
    <div style="display: flex"> 
