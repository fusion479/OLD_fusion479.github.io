...
<div class="sectioncontent">
    ...
    <div style="display: flex"> 
        ...
        <img src="DT.png" class="center" style="width:50vh; margin-top:-5%; margin-right:10%">
    </div>
    <p align="center" style="margin-top:-5%">Intake</p>
    <div style="display: flex"> 
        <img src="Succ.png" class="center" style="width:60vh; margin-top:-5%; margin-left:10%">
    ...
    <p align="center" style="margin-top:-5%">Lift</p>
    <div style="display: flex"> 
    ...
    <p align="center" style="margin-top:-5%">Deposit</p>
    <div style="display: flex"> 
    ...
    <p align="center" style="margin-top:-5%">Carousel Spinner</p>
    <div style="display: flex"> 
...
<div class="sectioncontent">
    ...
    <div style="display: flex">
        <small style="margin-left:10%; margin-right:10%; margin-top:-7%">All in all, these sensors work together to create a cohesive view of our robot, and help guide the mechanisms utilizing real-time feedback from the robot’s current status.
        </small>
    </div>
    <p align="center" style="margin-top:-3%">Autonomous Path Planning & Tuning Tools</p>
    <div style="display: flex"> 
